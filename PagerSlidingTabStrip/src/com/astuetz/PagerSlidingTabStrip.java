...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (currentTab instanceof TextView) {
			TextView tv = (TextView) tabsContainer.getChildAt(lastPosition);
			tv.setTextColor(tabTextColor);
			((TextView) currentTab).setTextColor(indicatorColor);
		}
	...
	public void onRestoreInstanceState(Parcelable state) {
		...
		lastPosition = savedState.lastPosition;
		requestLayout();
	}
	...
	public Parcelable onSaveInstanceState() {
		...
		savedState.lastPosition = lastPosition;
		return savedState;
	}
	...
	static class SavedState extends BaseSavedState {
		...
		public void writeToParcel(Parcel dest, int flags) {
			...
			dest.writeIntArray(new int[]{currentPosition,lastPosition});
		}
